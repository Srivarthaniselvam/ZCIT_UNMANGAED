CLASS zcit_util_22ad303 DEFINITION
  PUBLIC
  FINAL
  CREATE PRIVATE.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS get_instance RETURNING VALUE(ro_instance) TYPE REF TO zcit_util_22ad303.

    METHODS:
      set_hdr_value IMPORTING im_sales_hdr TYPE zcit_so_hdr_303
                    EXPORTING ex_created   TYPE abap_boolean,
      get_hdr_value EXPORTING ex_sales_hdr TYPE zcit_so_hdr_303,
      set_itm_value IMPORTING im_sales_itm TYPE zcit_so_itm_303
                    EXPORTING ex_created   TYPE abap_boolean,
      get_itm_value EXPORTING ex_sales_itm TYPE zcit_so_itm_303,
  ...
  PRIVATE SECTION.
    CLASS-DATA: gs_sales_hdr_buff   TYPE zcit_so_hdr_303,
                gs_sales_itm_buff   TYPE zcit_so_itm_303,
                gt_sales_hdr_t_buff TYPE tt_sales_hdr,
                gt_sales_itm_t_buff TYPE tt_sales_item,
                gv_so_delete        TYPE abap_boolean.
    CLASS-DATA mo_instance TYPE REF TO zcit_util_22ad303.
ENDCLASS.



CLASS zcit_util_22ad303 IMPLEMENTATION.
